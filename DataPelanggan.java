...
int nomor=1;
DefaultTableModel heni=new DefaultTableModel();
heni.addColumn("No");
heni.addColumn("Kode Barang");
heni.addColumn("Nama Barang");
heni.addColumn("Harga");
heni.addColumn("Supplier");
...
sql = "SELECT * FROM barang,supplier WHERE barang.kd_sup=supplier.kd_sup";
    ...
    while (res.next()) {
    heni.addRow(new Object[]{nomor++,res.getString(1),res.getString(2),res.getString(3),res.getString(6)});
  //  Object nextElement = res.nextElement();
            
        }
    pelanggan.setModel(heni);
